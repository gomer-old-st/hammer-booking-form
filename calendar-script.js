...
*/
	...
	function selectSched(e) {
		...
		document.getElementById('confirm').addEventListener('click', confirming);
	...
	function confirming() {
		$.ajax({
			type: 'GET',
			url: availabilityUrl+'/booking-service/availability',
			crossDomain: true,
			data: { 
