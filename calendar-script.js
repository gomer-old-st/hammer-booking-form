...
!function() {
  var data = [
    { eventName: 'Lunch Meeting w/ Mark', calendar: 'Work', color: 'homevisit' },
    { eventName: 'Interview - Jr. Web Developer', calendar: 'Work', color: 'clinicvisit' },
    { eventName: 'Demo New App to the Board', calendar: 'Work', color: 'telehealth' },
  ];
